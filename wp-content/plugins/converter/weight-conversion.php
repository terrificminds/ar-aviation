...
function html_form_code() {
	...
	echo '<input type="text" name="convert-from" class ="convert-from" placeholder="To Convert" maxlength="10">';
	echo '</div>';
	...
	echo '<div class="cbm-row cbm-row-1">';
		...
		echo '<input type="text" name="cbmlength-1" class ="cbmlength-1" placeholder="0" maxlength="10">';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmbreadth-1">Breadth</label>';
		echo '<input type="text" name="cbmbreadth-1" class ="cbmbreadth-1" placeholder="0" maxlength="10">';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmwidth-1">Width</label>';
		echo '<input type="text" name="cbmwidth-1" class ="cbmwidth-1" placeholder="0" maxlength="10">';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmpieces-1">Pieces</label>';
		echo '<input type="text" name="cbmpieces-1" class ="cbmpieces-1" placeholder="0" maxlength="10">';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmvolume-1">Volume</label>';
		echo '<input type="text" name="cbmvolume-1" class ="cbmvolume-1" placeholder="0" readonly>';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmcbm-1">CBM</label>';
		echo '<input type="text" name="cbmcbm-1" class ="cbmcbm-1" placeholder="0" readonly>';
		echo '</span>';
	echo '</div>';
	echo '</div>';
		...
		echo '<input type="text" name="cbm-total-volume" class ="cbm-total-volume" placeholder="o" readonly>';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbm-total">Total CBM</label>';
		echo '<input type="text" name="cbm-total" class ="cbm-total" placeholder="0" readonly>';
		echo '</span>';
		echo '</div>';
	echo '</div>';
	echo '<div class="nas-calc">';
		...
		echo '<input type="text" name="weight-in-kg" class ="weight-in-kg" placeholder="0" maxlength="10">';
		echo '</span>';
		echo '<span>';
		...
		echo '<input type="text" name="thc-in-kd" class ="thc-in-kd" placeholder="0" readonly>';
		echo '</span>';
		echo '</div>';
		echo '</div>';
	echo '</div>';
