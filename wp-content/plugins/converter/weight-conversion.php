...
function html_form_code() {
	...
	echo '<div class="cbm-row cbm-row-1">';
		...
		echo '<input type="text" name="cbmvolume[]" class ="cbmvolume-1" placeholder="100" readonly>';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmcbm-1">CBM</label>';
		echo '<input type="text" name="cbmcbm-1" class ="cbmcbm-1" placeholder="100" readonly>';
		echo '</span>';
	echo '</div>';
	echo '</div>';
		...
		echo '<input type="text" name="cbm-total-volume" class ="cbm-total-volume" placeholder="2.000" readonly>';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbm-total">Total CBM</label>';
		echo '<input type="text" name="cbm-total" class ="cbm-total" placeholder="2.000" readonly>';
		echo '</span>';
		echo '</div>';
	echo '</div>';
	echo '<div class="nas-calc">';
		...
		echo '<input type="text" name="nas-formula" class ="nas-formula" placeholder="2.000" readonly>';
		echo '<span>';
		echo '</div>';	
		...
		echo '<input type="text" name="thc-in-kd" class ="thc-in-kd" placeholder="2.000" readonly>';
		echo '</span>';
		echo '</div>';
		echo '</div>';
	echo '</div>';
