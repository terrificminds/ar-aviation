...
function html_form_code() {
	...
	echo '<input type="text" name="convert-from" class ="convert-from" placeholder="To Convert"><br>';
	echo '<label for="convert-into" class="into-measurement">Inches</label>';
	echo '<input type="text" name="convert-into" class ="convert-into" placeholder="Into"><br>';
	echo '<input type="button" value="convert" class="convert-weight" />';
	echo '</div>';
	echo '<div class="cbm-calculation">';
	echo '<div class="cbm-table">';
	echo '<div class="cbm-row-1">';
		echo '<label for="cbmlength-1">Length</label>';
		echo '<input type="text" name="cbmlength-1" class ="cbmlength-1" placeholder="100"><br>';
		echo '<label for="cbmbreadth-1">Breadth</label>';
		echo '<input type="text" name="cbmbreadth-1" class ="cbmbreadth-1" placeholder="100"><br>';
		echo '<label for="cbmwidth-1">Width</label>';
		echo '<input type="text" name="cbmwidth-1" class ="cbmwidth-1" placeholder="100"><br>';
		echo '<label for="cbmpieces-1">Pieces</label>';
		echo '<input type="text" name="cbmpieces-1" class ="cbmpieces-1" placeholder="100"><br>';
		echo '<label for="cbmvolume-1">Volume</label>';
		echo '<input type="text" name="cbmvolume[]" class ="cbmvolume-1" placeholder="100"><br>';
		echo '<label for="cbmcbm-1">CBM</label>';
		echo '<input type="text" name="cbmcbm-1" class ="cbmcbm-1" placeholder="100"><br>';
	echo '</div>';
	echo '</div>';
		echo '<a href="#" class="remove_field">Remove</a>';
		echo '<input type="button" value="Add Row" class="cbm-add-row" /><br>';
		echo '<input type="button" data-id="1" value="Calculate" class="cbm-calculate" /><br>';
		echo '<label for="cbm-total-volume">Total volume of weight</label>';
		echo '<input type="text" name="cbm-total-volume" class ="cbm-total-volume" placeholder="2.000"><br>';
		echo '<label for="cbm-total">Total CBM</label>';
		echo '<input type="text" name="cbm-total" class ="cbm-total" placeholder="2.000"><br>';
	echo '</div>';
	echo '<div class="nas-calc">';
	echo '<label for="weight-in-kg">Chargeable Weight in KG</label>';
	echo '<input type="text" name="weight-in-kg" class ="weight-in-kg" placeholder="100"><br>';
	echo '<label for="nas-formula">Formula</label>';
	echo '<input type="text" name="nas-formula" class ="nas-formula" placeholder="2.000"><br>';
	echo '<input type="button" value="Calculate" class="nas-calculate"/>';
	echo '<br>';
	echo '<label for="thc-in-kd">Total THC in KD</label>';
	echo '<input type="text" name="thc-in-kd" class ="thc-in-kd" placeholder="2.000"><br>';
	echo '</div>';
}
