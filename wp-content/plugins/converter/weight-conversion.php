...
function html_form_code() {
	...
	echo '<input type="text" name="convert-from" class ="convert-from" placeholder="To Convert" maxlength="5">';
	echo '</div>';
	...
	echo '<div class="cbm-row cbm-row-1">';
		...
		echo '<input type="text" name="cbmlength-1" class ="cbmlength-1" placeholder="0" maxlength="5">';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmbreadth-1">Breadth</label>';
		echo '<input type="text" name="cbmbreadth-1" class ="cbmbreadth-1" placeholder="0" maxlength="5">';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmwidth-1">Width</label>';
		echo '<input type="text" name="cbmwidth-1" class ="cbmwidth-1" placeholder="0" maxlength="5">';
		echo '</span>';
		echo '<span>';
		echo '<label for="cbmpieces-1">Pieces</label>';
		echo '<input type="text" name="cbmpieces-1" class ="cbmpieces-1" placeholder="0" maxlength="5">';
		echo '</span>';
		echo '<span>';
	...
	echo '</div>';
		...
		echo '<input type="text" name="cbm-total-volume" class ="cbm-total-volume" placeholder="0" readonly>';
		echo '</span>';
		echo '<span>';
	...
	echo '<div class="nas-calc">';
		...
		echo '<input type="text" name="weight-in-kg" class ="weight-in-kg" placeholder="0" maxlength="5">';
		echo '</span>';
		echo '<span>';
