...
$(".cbm-add-row").click(function(){
  ...
  html += '<div class="cbm-row cbm-row-'+rowcount+'">';
		html += '<span><label for="cbmlength-'+rowcount+'">Length</label>';
		html += '<input type="text" name="cbmlength-'+rowcount+'" class ="cbmlength-'+rowcount+'" placeholder="100"></span>';
		html += '<span><label for="cbmbreadth-'+rowcount+'">Breadth</label>';
		html += '<input type="text" name="cbmbreadth-'+rowcount+'" class ="cbmbreadth-'+rowcount+'" placeholder="100"></span>';
		html += '<span><label for="cbmwidth-'+rowcount+'">Width</label>';
    html += '<input type="text" name="cbmwidth-'+rowcount+'" class ="cbmwidth-'+rowcount+'" placeholder="100"></span>';
    html += '<span><label for="cbmpieces-'+rowcount+'">Pieces</label>';
		html += '<input type="text" name="cbmpieces-'+rowcount+'" class ="cbmpieces-'+rowcount+'" placeholder="100"></span>';
		html += '<span><label for="cbmvolume-'+rowcount+'">Volume</label>';
		html += '<input type="text" name="cbmvolume-'+rowcount+'" class ="cbmvolume-'+rowcount+'" placeholder="100"></span>';
		html += '<span><label for="cbmcbm-'+rowcount+'">CBM</label>';
    html += '<input type="text" name="cbmcbm-'+rowcount+'" class ="cbmcbm-'+rowcount+'" placeholder="100"></span>';
  html += '</div>';
